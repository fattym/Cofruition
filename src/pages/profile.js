...
import { Theme, Link, Box, Image, Text, Button, Section } from "@quarkly/widgets";
				...
				<StackItem width="50%" lg-width="100%">
					...
					<Stack>
						<StackItem width="100%" lg-width="33.3%" md-width="100%">
							<Override slot="StackItemContent" padding-bottom="100%" background="url(https://images.unsplash.com/photo-1532153975070-2e9ab71f1b14?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&w=2000) center/cover" />
						</StackItem>
